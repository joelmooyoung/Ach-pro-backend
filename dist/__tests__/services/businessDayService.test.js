...
describe('BusinessDayService', () => {
    ...
    beforeEach(() => {
        businessDayService = new businessDayService_1.BusinessDayService(mockHolidays);
    });
    describe('Business Day Validation', () => {
        ...
        test('should identify holiday weekends correctly', () => {
            ...
            const service2020 = new businessDayService_1.BusinessDayService([holiday2020]);
    ...
    describe('Edge Cases and Error Handling', () => {
        test('should handle empty holiday list', () => {
            const serviceWithoutHolidays = new businessDayService_1.BusinessDayService([]);
...
//# sourceMappingURL=businessDayService.test.js.map